"""
PythonAnywhere-specific category processor using Gemini AI for background processing of bookmark categories.
"""
import sys
import os
import logging
...
from twitter_bookmark_manager.deployment.pythonanywhere.database.db_pa import get_session, get_vector_store
...
LOG_FILE = os.path.join(LOG_DIR, 'pa_category_processor.log')
...
class CategoryProcessorPA:
    """PythonAnywhere implementation of adaptive category processing using Gemini AI"""
    ...
    def __init__(self):
        ...
        try:
            ...
            logger.info("✅ CategoryProcessorPA initialized successfully")
        except Exception as e:
            logger.error(f"❌ Error initializing CategoryProcessorPA: {e}")
